...
class Text(Element):
    ...
    def __init__(
        ...
        ...
    def update(
        self, value=..., background_color=..., text_color=..., font=..., visible=...
    ):  # -> None:
        """
...
class Graph(Element):
    ...
    def draw_point(self, point, size=..., color=...):  # -> _CanvasItemId | None:
        ...
        ...
    def draw_circle(
        self, center_location, radius, fill_color=..., line_color=..., line_width=...
    ):  # -> _CanvasItemId | None:
        """
        ...
        ...
    def draw_oval(
        self, top_left, bottom_right, fill_color=..., line_color=..., line_width=...
    ):  # -> _CanvasItemId | None:
        """
    ...
    def draw_rectangle(
        ...
        ...
    def draw_polygon(
        self, points, fill_color=..., line_color=..., line_width=...
    ):  # -> _CanvasItemId | None:
        """
        ...
        ...
    def draw_text(
        self, text, location, color=..., font=..., angle=..., text_location=...
    ):  # -> None:
        """
    ...
    def get_bounding_box(
        self, figure
    ):  # -> tuple[tuple[None, None] | tuple[Unknown, Unknown] | tuple[int, int], tuple[None, None] | tuple[Unknown, Unknown] | tuple[int, int]]:
        """
...
class TKCalendar(ttk.Frame):
    ...
    timedelta = ...
    def __init__(
        self, master=..., target_element=..., close_when_chosen=..., default_date=..., **kw
    ) -> None:
...
class Tree(Element):
    ...
    def add_treeview_data(self, node):  # -> None:
        ...
        ...
    def update(
        self, values=..., key=..., value=..., text=..., icon=..., visible=...
    ):  # -> Self@Tree | None:
        """
...
class Window:
    ...
    def current_location(
        self, more_accurate=...
    ):  # -> tuple[None, None] | tuple[int | None, int | None]:
        """
...
def read_all_windows(
    timeout=..., timeout_key=...
):  # -> tuple[None, None, None] | tuple[Window, Unknown | str, Unknown] | tuple[Window, str | Unknown | None, Unknown | None] | tuple[None, str, None]:
    """
...
class SystemTray:
    ...
    def __init__(
        self, menu=..., filename=..., data=..., data_base64=..., tooltip=..., metadata=...
    ) -> None:
        """
    ...
    def un_hide(self):  # -> None:
        ...
        ...
    def show_message(
        self, title, message, filename=..., data=..., data_base64=..., messageicon=..., time=...
    ):  # -> str:
        """
...
def Titlebar(
    title=..., icon=..., text_color=..., background_color=..., font=..., key=..., k=...
):  # -> Column:
    """
...
def button_color_to_tuple(
    color_tuple_or_string, default=...
):  # -> tuple[Literal['1234567890'], Literal['1234567890']]:
    """
...
def theme_previewer(
    columns=..., scrollable=..., scroll_area_size=..., search_string=..., location=...
):  # -> None:
    """
...
def execute_command_subprocess(
    command, *args, wait=..., cwd=..., pipe_output=..., merge_stderr_with_stdout=..., stdin=...
):
    """
